                ...
                <div className="p-6">
                  ...
                  <div className="bg-slate-800 rounded-xl p-6 min-h-[400px]">
                      ...
                      <div className="space-y-6">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          ...
                          <div className="bg-slate-900 p-4 rounded-xl border border-slate-700">
                            ...
                            <div className="text-2xl font-bold text-slate-100">R$ 45.6K</div>
                          ...
                          <div className="bg-slate-900 p-4 rounded-xl border border-slate-700">
                            ...
                            <div className="text-2xl font-bold text-slate-100">89.3%</div>
                        ...
                        <div className="bg-slate-900 p-4 rounded-xl border border-slate-700">
                          <h4 className="font-medium text-slate-100 mb-3">Atividade Recente</h4>
                          <div className="space-y-2">
                            <div className="flex items-center justify-between p-2 hover:bg-slate-800 rounded-lg">
                              <div className="flex items-center gap-3">
                                <div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
                                <span className="text-sm text-slate-300">Novo projeto criado</span>
                              </div>
                            ...
                            <div className="flex items-center justify-between p-2 hover:bg-slate-800 rounded-lg">
                              <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm text-slate-300">Usuário adicionado à equipe</span>
                              </div>
                            ...
                            <div className="flex items-center justify-between p-2 hover:bg-slate-800 rounded-lg">
                              <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm text-slate-300">Relatório gerado</span>
                              </div>
                    ...
                    {currentStep === 1 && (
                      <div className="space-y-6">
                        <div className="bg-slate-900 p-4 rounded-xl border border-slate-700">
                          <h4 className="font-medium text-slate-100 mb-3">Gerenciar Equipe</h4>
                          <div className="space-y-3">
                            <div className="flex items-center justify-between p-3 border border-slate-700 rounded-lg">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <div className="font-medium text-slate-100">João Silva</div>
                                  <div className="text-sm text-slate-400">Administrador</div>
                                </div>
                              </div>
                            ...
                            <div className="flex items-center justify-between p-3 border border-slate-700 rounded-lg">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <div className="font-medium text-slate-100">Ana Santos</div>
                                  <div className="text-sm text-slate-400">Gerente</div>
                                </div>
                              </div>
                              <span className="px-2 py-1 bg-emerald-500/20 text-emerald-400 text-xs rounded-full">
                                Ativo
                            ...
                            <div className="flex items-center justify-between p-3 border border-slate-700 rounded-lg">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <div className="font-medium text-slate-100">Roberto Costa</div>
                                  <div className="text-sm text-slate-400">Desenvolvedor</div>
                                </div>
                              </div>
                    ...
                    {currentStep === 2 && (
                      <div className="space-y-6">
                        <div className="bg-slate-900 p-4 rounded-xl border border-slate-700">
                          <h4 className="font-medium text-slate-100 mb-3">Análise de Performance</h4>
                          <div className="space-y-4">
                            <div>
                              <div className="flex justify-between text-sm mb-2">
                                <span className="text-slate-400">Taxa de Conclusão</span>
                                <span className="font-medium text-slate-100">87%</span>
                              </div>
                              <div className="w-full bg-slate-700 rounded-full h-2">
                                <div className="bg-gradient-to-r from-indigo-500 to-purple-600 h-2 rounded-full" style={{ width: '87%' }}></div>
                              </div>
                            </div>
                            <div>
                              <div className="flex justify-between text-sm mb-2">
                            ...
                            <div>
                              <div className="flex justify-between text-sm mb-2">
                                ...
                                <span className="font-medium text-slate-100">78%</span>
                              </div>
                              <div className="w-full bg-slate-700 rounded-full h-2">
                    ...
                    {currentStep === 3 && (
                      <div className="space-y-6">
                        <div className="bg-slate-900 p-4 rounded-xl border border-slate-700">
                          <h4 className="font-medium text-slate-100 mb-3">Configurações do Sistema</h4>
                          <div className="space-y-4">
                            <div>
                              ...
                              <input
                                ...
                                readOnly
                                className="w-full px-3 py-2 border border-slate-700 rounded-lg bg-slate-800 text-slate-100"
                              />
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-slate-300 mb-2">
                            ...
                            <div>
                              ...
                              <div className="flex gap-2">
                                <input
                                  ...
                                  readOnly
                                  className="flex-1 px-3 py-2 border border-slate-700 rounded-lg bg-slate-800 text-slate-100"
                                />
                                <button
                                  onClick={() => setShowPassword(!showPassword)}
                                  className="p-2 border border-slate-700 rounded-lg hover:bg-slate-700 transition-colors"
                                >
                                  {showPassword ? (
                      ...
                      {demoSteps.map((_, index) => (
                        <div
                          ...
                          className={`w-2 h-2 rounded-full transition-colors ${
                            index === currentStep ? 'bg-indigo-400' : 'bg-slate-600'
                          }`}
                        />
                      ))}
                    </div>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-slate-300">Acesso completo</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Check className="w-4 h-4 text-emerald-400" />
                    ...
                    <div className="flex items-center gap-2">
                      <Check className="w-4 h-4 text-emerald-400" />
                      <span className="text-sm text-slate-300">Sem cartão necessário</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-900 rounded-2xl shadow-xl p-6 border border-slate-800">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-medium text-slate-100">Analytics Avançado</div>
                      <div className="text-sm text-slate-400">Relatórios detalhados em tempo real</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Users className="w-5 h-5 text-indigo-400 mt-0.5" />
                    <div>
                      <div className="font-medium text-slate-100">Gestão de Equipe</div>
                      <div className="text-sm text-slate-400">Controle de acesso e permissões</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Zap className="w-5 h-5 text-indigo-400 mt-0.5" />
                    <div>
                      <div className="font-medium text-slate-100">Automação</div>
                      <div className="text-sm text-slate-400">Fluxos de trabalho inteligentes</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Shield className="w-5 h-5 text-indigo-400 mt-0.5" />
                    <div>
                      <div className="font-medium text-slate-100">Segurança</div>
                      <div className="text-sm text-slate-400">Criptografia de ponta a ponta</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl shadow-xl p-6 text-white">
                ...
                <Link
                  ...
                  className="block w-full py-3 bg-white text-indigo-600 rounded-xl font-semibold hover:bg-slate-50 transition-colors text-center"
                >
