            ...
            <div className="bg-slate-900 rounded-2xl shadow-xl p-6 border border-slate-800">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-slate-300">Projetos ilimitados</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-emerald-400" />
                  <span className="text-slate-300">10.000 visitas/mês</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-emerald-400" />
                ...
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-emerald-400" />
                  <span className="text-slate-300">Analytics avançado</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-emerald-400" />
              ...
              <div className="border-t border-slate-700 pt-4">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-slate-100">R$ 197,00</span>
                </div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-slate-400">Impostos</span>
                  <span className="text-slate-100">R$ 39,40</span>
                </div>
                <div className="flex justify-between items-center mb-4">
                  <span className="text-slate-400">Desconto (lançamento)</span>
                  <span className="text-emerald-400">-R$ 23,64</span>
                </div>
                <div className="flex justify-between items-center text-lg font-bold">
                  <span className="text-slate-100">Total</span>
                  <span className="text-indigo-400">R$ 212,76</span>
                </div>
              </div>
