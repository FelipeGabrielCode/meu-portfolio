            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-slate-700 dark:text-slate-300">Até 3 projetos</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-emerald-500" />
                  <span className="text-slate-700 dark:text-slate-300">1.000 visitas/mês</span>
                </div>
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-emerald-500" />
                ...
                <div className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-emerald-500" />
                  <span className="text-slate-700 dark:text-slate-300">Analytics básico</span>
                </div>
              </div>
              ...
              <div className="border-t border-slate-200 dark:border-slate-700 pt-4">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-slate-900 dark:text-slate-100">R$ 97,00</span>
                </div>
                <div className="flex justify-between items-center mb-4">
                  <span className="text-slate-600 dark:text-slate-400">Impostos</span>
                  <span className="text-slate-900 dark:text-slate-100">R$ 19,40</span>
                </div>
                <div className="flex justify-between items-center text-lg font-bold">
                  <span className="text-slate-900 dark:text-slate-100">Total</span>
                  <span className="text-primary">R$ 116,40</span>
                </div>
              </div>
